...
class h5p_libraries(models.Model):
    library_id = models.AutoField(primary_key=True, help_text='Identifier of the library')
    machine_name = models.CharField(null=False, default='', max_length=127, help_text='Full name of the library')
    title = models.CharField(null=False, default='', max_length=255, help_text='Short name of the library')
    ...
    fullscreen = models.PositiveSmallIntegerField(null=False, default=0, help_text='Display fullscreen button')
...
class h5p_libraries_languages(models.Model):
    ...
    language_json = models.TextField(null=False, help_text='The translations defined in json format')
...
class h5p_contents(models.Model):
    content_id = models.AutoField(primary_key=True, help_text='Identifier of the content')
    title = models.CharField(null=False, max_length=255)
    json_contents = models.TextField(null=False, help_text='The content in JSON format')
    ...
    filtered = models.TextField(null=False, help_text='Filtered version of json_contents')
    slug = models.CharField(null=False, max_length=127, help_text='Human readable content identifier that is unique')
...
class h5p_points(models.Model):
    content_id = models.PositiveIntegerField(null=False, help_text='Identifier of the content having a score')
    uid = models.PositiveIntegerField(null=False, help_text='Identifier of the user with this score')
    ...
    points = models.PositiveIntegerField(null=True, blank=True, help_text='Current point of the user')
    max_points = models.PositiveIntegerField(null=True, blank=True, help_text='Maximum point that the user can have')
...
class h5p_events(models.Model):
    user_id = models.PositiveIntegerField(null=False, help_text='Identifier of the user who caused this event')
